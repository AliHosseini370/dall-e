...
const Home = () => {
  ...
  const handleSearchChange = (e) => {
    ...
    setSearchTimeOut(
      setTimeout(() => {
        const searchRelusts = allPosts.filter((post) => post.name.toLowerCase().includes(searchText.toLowerCase()) || post.prompt.toLowerCase().includes(searchText.toLowerCase()));
        setSearchedResults(searchRelusts)
      }, 500)
    )
  }
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <div className='mt-16'>
        <FormField lableName='Search Posts' type='text' name='text' placeholder='Search Posts' value={searchText} handleChange={handleSearchChange} />
      </div>
